    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-body">
                ...
                <form action="{{route('new-app.insert')}}" name="accAdminFrm" id="accAdminFrm"
                    ...
                    <div class="form-group form-inline" id="div_app_name">
                        ...
                        <div class="col-md-6 p-0">
                            <input type="text" name="app_name" value="{{old('app_name')}}" id="app_name" placeholder="App Name"
                                class="form-control input-full required" autocomplete="off"/>
                    ...
                    <div class="form-group form-inline" id="div_category_id">
                        ...
                        <div class="col-md-6 p-0">
                            ...
                            <select name="category_id[]" class="form-control dev_mysel" id="category_id" multiple>
                                ...
                                <option value="{{$appname->id}}">{{$appname->category_name}}</option>
                                @endforeach
