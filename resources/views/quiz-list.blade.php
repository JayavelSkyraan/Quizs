...
<div class="d-sm-flex align-items-center mb-4">
    ...
    <ul class="breadcrumbs">
        <li class="content">
            <a href="{{url('app-list')}}">
                <i class="fa fa-home" style="cursor:pointer;font-size:20px;"></i>
            </a>
        </li>
        <li class="separator">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="card-head-row">
                <h4 class="card-title mt-3">Quiz List
                    ...
                    <ul class="nav nav-pills nav-secondary nav-pills-no-bd " role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active"
                                ...
                                href="{{url('add-new-quiz')}}"> <i class="fa fa-plus"></i>&nbsp; Add New Quiz</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 " style="padding: 0rem 1.25rem;">
                    ...
                    <!--<h3>Search</h3>-->
                    <!--</div>-->
                    <form action="{{route('quizlist.paginate')}}" method="get" >
                    @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="select" class="form-control">
                                    ...
                                    <option name="id" value="id" <?php if(isset($_GET["select"])){ if($_GET["select"]=="id"){ echo 'selected';} }?>>Quiz ID</option>
                                    <option name="category" value="category" <?php if(isset($_GET["select"])){ if($_GET["select"]=="category"){ echo 'selected';} }?>>Category Name</option>
                                    <option name="question" value="question" <?php if(isset($_GET["select"])){ if($_GET["select"]=="question"){ echo 'selected';} }?>>Question Name</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
            ...
            <div class="btn-wrapper text-center d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <form action="{{route('quizlist.paginate')}}" name="perPageForm" method="get">
            ...
            <div class="btn-wrapper text-center d-flex justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="card-title"> Total Quiz : <?php $count = DB::table('quizs')->count(); echo $count; ?>
                    </h4>
                    ...
                    <table id="feedback_list_table" class="display table table-striped table-hover table-bordered ">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th id="sort_desc_id">Quiz ID<i class="fas fa-sort" id="sort_desc_id1" name="sort_desc_id"></i></th>
                                @else
                                <th id="sort_asc_id">Quiz ID<i class="fas fa-sort" id="sort_desc_id2" name="sort_asc_id"></i></th>
                                @endif

                                @if(url('quiz-list/quiz/question/asc') == url()->current())
                                <th id="sort_desc_name">Questions<i class="fas fa-sort "></i></th>
                                @else
                                <th id="sort_asc_name">Questions<i class="fas fa-sort "></i></th>
                                @endif

                                @if(url('quiz-list/quiz/category_name/asc') == url()->current())
                                <th id="desc_category_id">Category Name<i class="fas fa-sort "></i></th>
                                @else
                                <th id="asc_category_id">Category Name<i class="fas fa-sort "></i></th>
                                @endif
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{strip_tags($select->question_name)}}</td>
                                ...
                                <td class="text-center">
                                    <div class="form-button-action">
                                        ...
                                        <a href="{{url('quiz-list/edit',$select->id)}}" data-toggle="tooltip" title=""
                                        ...
                                        <a href="{{ url('quiz-list/delete',$select->id) }}" data-toggle="tooltip"
            ...
            <form action="{{url('quiz-list/update-status/'.$select->id)}}" method="post">
                @csrf
                @if($select->status == '1')
                <td>
            ...
            @else
            <tr>
                <td colspan="9" class="text-center bg-mute">Result not found.</td>
            </tr>
            @endif
...
$(document).ready(function() {
    ...
    $("#sort_asc_id").click(function() {
        window.location.href = url + "/quiz-list/quiz/id/asc?perPage=" + page;

    });

    $("#sort_desc_id").click(function() {
        window.location.href = url + "/quiz-list/quiz/id/desc?perPage=" + page;
    });


    //name
    $("#sort_asc_name").click(function() {
        window.location.href = url + "/quiz-list/quiz/question/asc?perPage=" + page;

    });


    $("#sort_desc_name").click(function() {
        window.location.href = url + "/quiz-list/quiz/question/desc?perPage=" + page;

    });

    $("#asc_created_at").click(function() {
        window.location.href = url + "/quiz-list/quiz/created_at/asc?perPage=" + page;


    });

    $("#desc_created_at").click(function() {
        window.location.href = url + "/quiz-list/quiz/created_at/desc?perPage=" + page;

    });

    $("#desc_category_id").click(function() {
        window.location.href = url + "/quiz-list/quiz/category_name/desc?perPage=" + page;

    });

    $("#asc_category_id").click(function() {
        window.location.href = url + "/quiz-list/quiz/category_name/asc?perPage=" + page;
